...
var script = {
  ...
  computed: {
    datetimeLocale: function datetimeLocale () {
      var result = this.locale || luxon.Settings.defaultLocale;
      return result
    },
    inputValue: function inputValue () {
      ...
      if (typeof format === 'string') {
        return this.datetime ? luxon.DateTime.fromISO(this.datetime).setZone(this.zone).setLocale(this.datetimeLocale).toFormat(format) : ''
      } else {
    ...
    popupMinDatetime: function popupMinDatetime () {
      return this.minDatetime ? luxon.DateTime.fromISO(this.minDatetime).setLocale(this.datetimeLocale).setZone(this.zone) : null
    },
    popupMaxDatetime: function popupMaxDatetime () {
      return this.maxDatetime ? luxon.DateTime.fromISO(this.maxDatetime).setLocale(this.datetimeLocale).setZone(this.zone) : null
    }
  },

  methods: {
    emitInput: function emitInput () {
      var datetime = this.datetime ? this.datetime.setLocale(this.datetimeLocale).setZone(this.valueZone) : null;
